...
public class Normal extends Exame {
    ...
    public Normal(Disciplina disciplina,Data data,Data duracao,ArrayList<Sala> sala,Docente responsavel,ArrayList<Docente> vigilantes,ArrayList<NaoDocente> funcionarios,ArrayList<Aluno> inscritos,ArrayList<Classificacao> notas){
